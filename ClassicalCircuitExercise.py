...
class ClassicalCircuit:
    def __init__(self, filename):
        ...
        self.input_gates = (
            []
        )  # list with n_inputs numbers indicating which are the input gates
        self.output_gates = (
            []
        )  # list with n_outputs numbers indicating which are the output gates
        self.internal_gates = (
            []
        )  # list with n_internal numbers indicating which are the internal gates
        self.gates = []
        self.read(filename)
